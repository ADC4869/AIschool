...
<head>
    ...
    <link rel="stylesheet" href="./css/kqhthocsinh.css">
</head>
...
<body>
    ...
    <main>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="grade-review">
                            ...
                            <div class="review">
                                ...
                                <p>Very good</p>
                                <div class="button">
                                    <button type="button" onclick="openModal()">Phúc khảo</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="main_link">
            <a href="../forum.php"><u>Một số cách cải thiện kết quả học tập</u></a>
        </div>
