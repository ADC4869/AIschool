    ...
    <header>
        ...
        <div class="subheader">
            ...
            <div class="infodetail">
                <p class="student-name data_hovatenhocsinh">Từ Văn Tú</p>
                <p class="student-class data_lophoc">9A1</p>
                <p class="data_diemtrungbinh">Điểm trung bình: <span style="color: green">8.8</span></p>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <!-- Tổng kết môn Toán -->
                            <td>
                                <button class="enter-grade-button"><i data-feather="plus" style="color: #bcbcbd"></i></button>
